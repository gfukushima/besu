...
public class ExecutionWitnessParameter {
    ...
    @JsonCreator
    public ExecutionWitnessParameter(@JsonProperty("stateDiff") final StateDiffParameter stateDiff,
    ...
    public static ExecutionWitnessParameter fromExecutionWitness(final ExecutionWitness executionWitness) {
    ...
    public ExecutionWitness toExecutionWitness() {
        return new ExecutionWitness(StateDiffParameter.toStateDiff(stateDiffParameter),
