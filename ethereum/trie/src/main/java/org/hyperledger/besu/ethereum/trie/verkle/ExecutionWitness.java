...
public class ExecutionWitness {
  ...
  // TODO VERKLE: Created for BlockchainReferenceTestCaseSpec.class for now
  public ExecutionWitness(final Bytes executionWitness) {
    this.stateDiff = null;
    this.verkleProof = null;
  }
  ...
  public static void writeTo(final RLPOutput rlpOutput) {
    rlpOutput.startList();
    // TODO VERKLE WRITE EXECUTION WITNESS RLP
    rlpOutput.endList();
  }
